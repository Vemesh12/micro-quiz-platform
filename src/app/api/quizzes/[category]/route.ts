...
const quizzesData = {
  history: [
    ...
    },
    {
      id: 'history-2',
      title: 'World Wars',
      description: 'Learn about the major events of World War I and II',
      questionCount: 7,
      difficulty: 'Medium'
    },
    {
  ...
  science: [
    ...
    },
    {
      ...
      description: 'Cell structure and basic biological concepts',
      questionCount: 5,
      difficulty: 'Easy'
    },
    {
...
export async function GET(
  ...
  const quizzes = quizzesData[category as keyof typeof quizzesData]
